...
/**
 * No-op `FactorDriver` used by tests that need to register an
 * extension whose runtime behaviour does not matter.
 *
 ...
 * `BackupCodeDriver::hash()` and would otherwise silently corrupt
 * state if the consumer rebound the driver name to something
 * incompatible.
 *
