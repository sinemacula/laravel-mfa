 ...
 * identity.
 *
 * Fires after the factor record has been deleted or otherwise marked
 * inactive. Consumers can subscribe to emit audit-log entries, send
 * confirmation notifications, or recalculate whether the identity still
 * has enough active factors to satisfy policy.
 *
